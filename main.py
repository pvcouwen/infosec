...
if __name__ == "__main__":
    ...
    vote_message = client.generate_vote("16karakters_lang")
    ...
    sym_key_message = Server.handle_sym_key_request(client_key, verification_secret, ip)
    # Server -> Client : Server sends symmetric key + secret
    encrypted_vote_ID = client.send_voter_id()
    ...
    storage_response = "16karakters_lang"  # = Storage.handle_id()
    ...
    client.recieve_vote(encrypted_vote)
